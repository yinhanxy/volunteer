...
<html lang="zh-CN">
  <head>
	...
	<link href="${sr}css/new.css" rel="stylesheet">
  	...
  	<link href="${sr}cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css" />
    <link href="${sr}cron/themes/icon.css" rel="stylesheet" type="text/css" />
    <link href="${sr}cron/icon.css" rel="stylesheet" type="text/css" />
...
<div class="easyui-layout" style="width:642px;height:560px; border: 1px rgb(202, 196, 196) solid;
            border-radius: 5px;marginn:0;padding:0;">
            <div style="height: 100%;padding:0;margin:0;">
                <div class="easyui-tabs" data-options="fit:false,border:false" style="padding:0;margin:0;">
                    <div title="秒" style="margin:0;padding:0;">
                        <div class="line">
                    ...
                    <div title="分钟" style="margin:0;padding:0;">
                        <div class="line" >
                    ...
                    <div title="小时" style="margin:0;padding:0;">
                        <div class="line" >
                    ...
                    <div title="日" style="margin:0;padding:0;">
                        <div class="line" >
                    ...
                    <div title="月" style="margin:0;padding:0;">
                        <div class="line">
                    ...
                    <div title="周" style="margin:0;padding:0;">
                        <div class="line" >
                    ...
                    <div title="年" style="margin:0;padding:0;">
                        <div class="line" >
            ...
            <div data-options="region:'south',border:false" style="height:285px">
                ...
                <div style="text-align: center; margin-top: 5px;">
                    <script type="text/javascript">
                        function btnFan() {
                      	...
                      	function clearData(){
                      		$("input[name=v_second]").attr("checked",false);
                      		$("input[name=v_min]").attr("checked",false);
                      		$("input[name=v_hour]").attr("checked",false);
                      		$("input[name=v_day]").attr("checked",false);
                      		$("input[name=v_mouth]").attr("checked",false);
                      		$("input[name=v_week]").attr("checked",false);
                      	}
    ...
    <script src="${sr}cron/jquery.easyui.min.js" type="text/javascript"></script>
    <script src="${sr}cron/cron.js" type="text/javascript"></script>
