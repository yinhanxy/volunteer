...
<body class="v-page-body">
	<div class="page-container">
		<div class="panel">	
				<form id="addSubAreaForm" action="${webroot}area/addArea.do">
					<div class="row">
					<table class="table table-bordered dataTable no-footer">
						<tr>
							...
							<td class="col-xs-4">
								<div class="input-group">
									<input type="hidden" name="parentId"  id="parentId" value="${area.id}"/>
						...
						<tr>
							...
							<td><input name="code" class="form-control"/>
                   			</td>
						</tr>
						<tr>
	...
	layui.use(['jquery','layer','laytpl'], function(){
		$("#addSubAreaForm input,select").on("change",function(){
		...
		$('#sub').on('click', function() {
			errors=[];
			if( !$('#addSubAreaForm').isValid({},conf, true)) {
				isForm=false;
				...
				postFormData("addSubAreaForm",true,addSubArea);
		    }
