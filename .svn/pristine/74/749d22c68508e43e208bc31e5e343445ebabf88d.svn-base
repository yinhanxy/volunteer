...
<body class="v-page-body">
	<div class="page-container">
		<div class="panel">
			<form id="addScheduleForm" action="${webroot}schedule/add.do" method="post">
				<div class="row">
				...
				<table class="table table-bordered dataTable no-footer">
					<tr>
						...
						<td class="col-xs-10">
							 <input type="text" class="form-control" name="jobName" placeholder="任务名称(2-50位的汉字与字母)"  value=""
					...
					<tr>
						...
						<td class="col-xs-10">
							<input type="text" class="form-control" name="beanName" placeholder="JAVA BEAN"  value=""/>
                  			</td>
					</tr>
					...
					<tr>
						...
						<td >
						<input type="text" class="form-control"  name="params" id="params" style="background:#fff;cursor:pointer;" placeholder="参数值"  value="" />
                  		</td>
					</tr>
					<tr>
						...
						<td class="col-xs-10">
							...
							<input type="text" class="form-control" name="cronExpression" placeholder="Cron表达式"  value="" />
					...
					<tr>
						...
						<td class="col-xs-10">
							<textarea rows="4" style="resize:none;" cols="50" class="form-control"  placeholder="备注"  name="remark"></textarea>
                  		</td>
					</tr>
				</table>
				</div>
