...
function(e) {
    ...
    a.prototype = {
        ...
        _generateRating: function() {
            ...
            i.$rating = a = e(document.createElement("div")).attr("class", "rating-stars").appendTo(n).append(i._getStars("empty")).append(i._getStars("filled")),
        ...
        _renderCaption: function() {
            ...
            if (n.showCaption) {
                if (a = n.fetchCaption(r), i && i.length) return t.addCss(i, "caption"),
                i.html(a),
                void(n.$caption = i);
        ...
        _renderClear: function() {
            ...
            if (n.showClear) {
                if (a = n._getClearClass(), r.length) return t.addCss(r, a),
                r.attr({
        ...
        _initEvents: function() {
            ...
            e.events = {
                ...
                clearMouseMove: function(t) {
                    var a, n, r, i; ! e.events._noMouseAction(t) && e.hoverOnClear && (e.clearClicked = !1, a = '<span class="' + e.clearCaptionClass + '">' + e.clearCaption + "</span>", n = e.clearValue, r = e.getWidthFromValue(n) || 0, i = {
                        caption: a,
                        width: r,
                        val: n
                    },
        ...
        _listen: function() {
            ...
            l = a.$clear,
            s = a.events;
            return t.handler(i, "touchstart touchmove touchend", e.proxy(s.initTouch, a)),
        ...
        fetchCaption: function(e) {
            ...
            return o && o !== s.clearValue && (o = t.applyPrecision(o, t.getDecimalPlaces(s.step))),
        ...
        destroy: function() {
            var a = this,
            n = a.$element;
            return t.isEmpty(a.$container) || a.$container.before(n).remove(),
    ...
    e.fn.rating = function(n) {
        ...
        switch (r.shift(), this.each(function() {
            ...
            p = {},
            h = {};
            o || (u && (p = e.fn.ratingThemes[u] || {}), "en" === d || t.isEmpty(e.fn.ratingLocales[d]) || (h = e.fn.ratingLocales[d]), l = e.extend(!0, {},
            e.fn.rating.defaults, p, e.fn.ratingLocales.en, h, c, s.data()), o = new a(this, l), s.data("rating", o)),
