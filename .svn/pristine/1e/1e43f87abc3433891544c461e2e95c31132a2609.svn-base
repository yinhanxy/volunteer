...
@Entity
@Table(name="logger_bak")
public class LoggerBak implements Serializable{
	...
	@Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "select SEQ_LOGGER_BAK.nextval from dual")
    private Long id;
