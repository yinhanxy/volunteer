...
<body >
	<div style="padding: 20px;" class="form-inline" >
		...
		<div  style="padding-top: 10px;float:right;">
		    ...
		    <form class="form-inline" id="searchVolunteerForm" action="${webroot}blackList/selectVolunteer.do" style="margin-bottom: 10px;" onsubmit="return false">
				...
				<span><input type="text" id="userName" name="userName" class="form-control"></span>
				<!-- <span>
					<label >所属服务队：</label>
...
<script type="text/javascript">
	...
	*/
	...
	function addVolunteerToBlack(){
		var layer = layui.layer;
		var volunteerId;
		var userName;
		var idcard;
		var certTeam;
		var selected=$("#pageData input:checked"); 
		...
		if(!volunteerId){
			layer.msg('请选择要加入黑名单的志愿者！',{time:1000});
			return false;
		}else{
			var data={"volunteerId":volunteerId,"userName":userName,"idcard":idcard,"certTeam":certTeam};
			return data;
		}
	}
