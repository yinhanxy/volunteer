...
<body class="v-page-body">
	<div class="page-container">
		<div class="panel" id="mainform">
			<form id="addCertCheckForm" action="${webroot}cert/addCertCheck.do" >
				<div class="row">
					<table class="table table-bordered dataTable no-footer">
				    	...
				    	<tr>
						    ...
						    <td>
						      <!-- <input type="text" class="form-control" id="checkYear" placeholder="年度审核年份" name="checkYear" 
	...
	layui.use(['jquery','layer','laytpl'], function(){
		...
		var currDate=getFormatDate(null,"yyyy");
		$("#checkYear").val(currDate);
		...
		$("#addCertCheckForm input,select").on("change",function(){
				$(this).validate(function(valid, elem) {
			});
		});
	 
		$.validate({
		 	form : "#addCertCheckForm",
			modules : 'security',
		...
		$('#sub').on('click', function() {
			errors =[];
			if( !$('#addCertCheckForm').isValid({},conf, true)) {
				...
				postFormData("addCertCheckForm",true,addResult);
		    }
