		        ...
		        <div class="page-title list-page">
		            <div class="title-env">
		                <ol class="breadcrumb bc-1" style="margin: 0px;">
		                    ...
		                    <li class="active">
		                        <a  href="${webroot}activity/registrationManage.html"><strong>报名管理</strong></a>
		                    </li>
		                </ol>
		            </div>
		        </div>
		        ...
		        <div class="table-panel panel">
		            ...
		            <div class="panel-heading" style="padding-bottom: 0px;">
		           			<div class="btn-toolbar" style="margin-left: 0px;">
			           			<form class="form-inline" id="searchForm" action="${webroot}activity/registrationManage.do" method="POST">
			           				<div class="row">
			                        ...
			                        <tr role="row"
										...
										<td>
											...
											<span class="btn-group btn-group-sm btn-group-xs">
												<shiro:hasPermission name="/activity/management.html">
											   		<a class="btn btn-info btn-icon icon-left btn-one-last" style="margin-right:5px;" title="报名管理" onclick="manage({{item.id}})"><i class="fa fa-pencil-square-o">报名管理</i></a>
												</shiro:hasPermission>
                                            </span>
			                                </div>
			                            </td>
	...
	*/
	...
	function manage(id){
		...
		var index=layer.open({
		  ...
		  maxmin:true,
		  scrollbar: false,
		  content: ["${webroot}activity/management.html?aId="+id],
