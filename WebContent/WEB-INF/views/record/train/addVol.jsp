...
<body >
	...
	<div style="padding: 20px;width: 100%;float:center;" class="form-inline">
		...
		<div  style="padding-top: 10px;float:right;">
		    ...
		    <form class="form-inline" id="searchUsersForm"  action="${webroot}record/showVols.do" style="margin-bottom: 10px;" onkeydown="if(event.keyCode==13){return false;}">
		...
		<script id="templateData" type="text/html">
							{{#  layui.each(d.list, function(index, item){ }}	
			                            ...
			                            <td width="40" style="text-align:center">
											<input type="checkbox" class="ace" value="{{item.id}}" {{item.trainIdList==""?"":"name='isOwn'"}}>
										</td>
	...
	function addVolsUnderTrain(){
		...
		if(!ids){
			...
			return false;
				...
				var url="${webroot}record/addTrainVol.do";
				params={"ids":ids,"trainId":trainId};
