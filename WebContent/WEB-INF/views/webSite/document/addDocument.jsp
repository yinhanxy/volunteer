...
<body class="v-page-body">
	<div class="page-container">
		<div class="panel" style="padding: 10px 20px;">
				<form id="addDocForm" action="${webroot}document/addDocument.do" onsubmit="return false;">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							...
							<tr class="row">
								<td>来源</td>
	                   			<td><input type="text"  class="form-control" name="source" id="source"/></td>
							</tr>
							<tr class="row">
								<td><label>时间<small><code >*</code></small></label></td>
	                   			<td>
	                   				<div class="date form_datetime" id="datetimepicker" data-date-format="yyyy-mm-dd hh:ii:ss">
									    <input type="text" class="form-control" name="reltime" id="reltime" value="${relTime}">
							...
							<tr class="row">
								<td>摘要</td>
	                   			<td><textarea  class="form-control" id="summary" name="summary" rows="8"></textarea></td>
							</tr>
						</table>
						</div>
					</div>
					...
					<input type="hidden" id="token" name="token" value="${DocumentController_addDocument_token}"/>
			    </form>
		</div>
	</div>
	...
	*/
	function selectChannel(){
		...
		layer.open({
		  ...
		  maxmin: true,
		  scrollbar: true,
		  content: "${webroot}document/selectChannel.html?channelId="+channelId,
		  btn : [ '确定', '取消' ], 
